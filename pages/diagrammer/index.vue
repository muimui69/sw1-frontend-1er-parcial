...
onMounted(() => {
    ...
    if (userId) {
        roomsStore.fetchRoomsByUser(userId); // Cargamos las salas al montar si el userId está disponible
    }
});
    ...
    <client-only>
        <div class="w-full py-24">
            <div class="container mx-auto px-4 md:px-6">
                <h1 class="text-4xl font-bold mb-10">Mis salas</h1>
                ...
                <div class="rounded-md border">
                    <Table>
                        ...
                        <TableBody>
                            ...
                            <template v-else>
                                <TableRow>
                                    <TableCell colspan="3" class="text-center">Cargando salas...</TableCell>
                                </TableRow>
                            </template>

                            <template v-if="!roomsStore.loading && !roomsStore.rooms?.length">
                                <TableRow>
                                    <TableCell colspan="3" class="text-center">No hay salas.</TableCell>
                                </TableRow>
                            </template>
                        </TableBody>
                    </Table>
